...
from poker_env.Texas.action import AbstractAction
...
class CFRAgent(Agent):
    ...
    def __init__(self, env):
        ...
        self.abstract_action_space = [_ for _ in AbstractAction]
        self.iterations = 0
    ...
    def decode_action(self, action, state):
        ...
        if state.need_action_abstraction():
            return self.abstract_action_space[action].translate_from(state)
        else:
