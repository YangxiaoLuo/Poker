...
from poker_env.LimitTexas.game import LimitTexasHoldemGame as Game
from poker_env.LimitTexas.action import Action
from poker_env.agents.base_agent import Agent


class LimitTexasHoldemEnv:
    '''
    Heads-Up Limit Texas Hold'em Poker Environment
    ...
    def __init__(self, allow_step_back=False, num_players=2, small_blind=1, big_blind=2):
        '''
        Initialize the Toy Poker environment
        '''
    ...
    @property
    def player_num(self):
        return self.__game.get_player_num()
    ...
    def set_agents(self, agents):
        ...
        if len(self.__agents) != self.player_num:
